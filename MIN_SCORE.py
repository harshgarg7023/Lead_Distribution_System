...
def match_leads_with_posp(leads, posps):
    ...
    for _, lead in leads.iterrows():
        ...
        for _, posp in posps.iterrows():
            ...
            perf_score = posp.get("performance_score", 0)  # 🆕 performance impact
            ...
            if lead_city_norm and posp_city_norm and lead_city_norm == posp_city_norm:
                ...
                base_geo_score = 10
                total_score = base_geo_score + recency_score + perf_score  # 🆕 add performance
        ...
        if not best_matches:
            # no strong enough match, skip this lead
            continue
...
def run_pipeline():
    ...
    if not matched_df.empty:
        ...
        print("\nNo matches created for new leads (all below MIN_SCORE).")
